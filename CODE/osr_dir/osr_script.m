...
%% Parameters 
num_unseen = 2; % number of unseen classes
...
labeled_pairs = 15; % The number of category pairs that are used for creating the O matrix
...
for k = 1:10
    ...
    % LINE 2
    %relative_att_predictions = feat*relative_att_predictor;
    %%%%%%%%%%%%%%%
    ...
    [means_unseen, Covariances_unseen] = meanandvar_forcat(Train_samples,unseen,new_cat_order,8,looseness_constraint);
