...
%%%%%%%%%%%%%%%%%%%%%%%%%%
% This version of the function only returns an accuracy on unseen classes.
%%%%%%%%%%%%%%%%%%%%%%%%%%%

function accuracy = BayesClass_RelAtt_unseen_only(predicts,ground_truth,means,Covariances,used_for_training,unseen)
