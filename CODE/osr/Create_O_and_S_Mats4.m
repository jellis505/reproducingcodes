...
function [O,S] = Create_O_and_S_Mats4(category_order,used_for_training,class_labels,num_classes,unseen,trainpics,att_combos)
...
test_combos(2,1) = seen(rand_seen(1)); test_combos(2,2) = seen(rand_seen(3));
test_combos(3,1) = seen(rand_seen(1)); test_combos(3,2) = seen(rand_seen(4));
test_combos(4,1) = seen(rand_seen(1)); test_combos(4,2) = seen(rand_seen(5));
test_combos(5,1) = seen(rand_seen(2)); test_combos(5,2) = seen(rand_seen(3));
test_combos(6,1) = seen(rand_seen(2)); test_combos(6,2) = seen(rand_seen(4));
test_combos(7,1) = seen(rand_seen(5)); test_combos(7,2) = seen(rand_seen(2));
test_combos(8,1) = seen(rand_seen(6)); test_combos(8,2) = seen(rand_seen(2));
test_combos(9,1) = seen(rand_seen(3)); test_combos(9,2) = seen(rand_seen(4));
test_combos(10,1) = seen(rand_seen(3)); test_combos(10,2) = seen(rand_seen(5));
test_combos(11,1) = seen(rand_seen(3)); test_combos(11,2) = seen(rand_seen(6));
test_combos(12,1) = seen(rand_seen(4)); test_combos(12,2) = seen(rand_seen(5));
%test_combos(13,1) = seen(rand_seen(3)); test_combos(13,2) = seen(rand_seen(2));
%test_combos(14,1) = seen(rand_seen(4)); test_combos(14,2) = seen(rand_seen(5));
%test_combos(15,1) = seen(rand_seen(7)); test_combos(15,2) = seen(rand_seen(6));
%test_combos(16,1) = seen(rand_seen(1)); test_combos(16,2) = seen(rand_seen(8));
