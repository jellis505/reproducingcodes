...
test_combos(4,1) = seen(rand_seen(7)); test_combos(4,2) = seen(rand_seen(8));
...
test_combos(7,1) = seen(rand_seen(5)); test_combos(7,2) = seen(rand_seen(7));
test_combos(8,1) = seen(rand_seen(6)); test_combos(8,2) = seen(rand_seen(8));
...
test_combos(11,1) = seen(rand_seen(7)); test_combos(11,2) = seen(rand_seen(3));
test_combos(12,1) = seen(rand_seen(8)); test_combos(12,2) = seen(rand_seen(4));
